...
var AccountSettingsComponent = /** @class */ (function () {
    ...
    AccountSettingsComponent.prototype.updateDetails = function (s, l, t) {
        ...
        }, function (err) { return (Materialize.toast("Something's not right", 1500, 'red white-text'), _this.preloader = false); }, function () { return _this.preloader = false; });
    };
