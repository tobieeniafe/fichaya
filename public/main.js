    ...
    AccountSettingsComponent.prototype.getUser = function () {
        ...
        this.accountSettingService.getUserDetails().subscribe(function (data) {
            if (data.success == true) {
                ...
                _this.user = model;
                _this.user.locations = [model.address.location, 'island', 'mainland'];
                _this.user.subscriptions = [model.plan.subscription, 'daily', 'weekly', 'monthly'];
                _this.user.types = [model.plan.plan, 'deep cleaning', 'regular cleaning'];
                console.log(_this.user.locations);
                console.log(_this.user.subscriptions);
                console.log(_this.user.types);
...
var User = /** @class */ (function () {
    function User() {
        ...
        this.types = ['deep cleaning', 'regular cleaning'];
    }
    return User;
}());
